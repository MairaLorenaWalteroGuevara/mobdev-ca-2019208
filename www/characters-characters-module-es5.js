  ...
  function srcAppPagesCharactersCharactersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharactersPage = /*#__PURE__*/function () {
      function CharactersPage(router, api) {
        ...
        this.router = router;
        this.api = api; // I create a variable type array to put all the elements or characters from the api 

        this.characters = []; // the offset is to start the count of element 0 in the array and the maximum to limited the dowlonload characters to 65
