...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["deaths-deaths-module"], {
  ...
  function srcAppPagesDeathsDeathsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DeathsPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _deaths_routing_module__WEBPACK_IMPORTED_MODULE_5__["DeathsPageRoutingModule"]],
  ...
  function srcAppPagesDeathsDeathsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DeathsPage = /*#__PURE__*/function () {
      function DeathsPage(router, api) {
        ...
        this.router = router;
        this.api = api; // variable type array to storage all my variables deaths

        this.newDeaths = []; // variable to storage the text from the input in the searchbar from my html 
      ...
      _createClass(DeathsPage, [{
        ...
        value: function initializeItems() {
          ...
          this.deaths = this.api.getDeaths(); // I am subscribe is a method that comes from rxjs library 

          this.deaths.subscribe(function (newdeath) {
            // Subscribe call the observable and this.newDeaths = [] put the staff inside of the observable inside of the array
            _this.newDeaths = [newdeath]; // console it is only to check the info in console 
        ...
        key: "searchDeath",
        value: function searchDeath(event) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])], DeathsPage);
    /***/
  }
}]);
