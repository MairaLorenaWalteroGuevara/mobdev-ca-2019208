...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    QuotesPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _quotes_routing_module__WEBPACK_IMPORTED_MODULE_5__["QuotesPageRoutingModule"]],
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuotesPage = /*#__PURE__*/function () {
      function QuotesPage(router, api) {
        ...
        this.router = router;
        this.api = api; // Ad array to storage all my varibles quotes 

        this.items = []; // variable to storage the text writing in the searchbar from my html 
      ...
      _createClass(QuotesPage, [{
        ...
        key: "openDetails",
        value: function openDetails(quotes) {
          var quotesId = quotes.quote_id;
          this.router.navigateByUrl("/tabs/quotes/".concat(quotesId));
        ...
        value: function initializeItems() {
          ...
          this.quotes.subscribe(function (item) {
            _this.items = [item]; // console it is only to check the info in console 
            //console.log( data); 
          });
        ...
        value: function searchQuote(event) {
          ...
          this.searchText = text; // I am taking "text" constant and storage in searchtext in order to use it in the search filter in the html. 
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"]])], QuotesPage);
    /***/
  }
}]);
